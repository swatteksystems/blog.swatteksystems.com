...
[Skip to content.](https://blog.swatteksystems.com/old/topics/help#content)
| [Skip to
navigation](https://blog.swatteksystems.com/old/topics/help#portlet-navigation-tree)
...
dir="ltr"> <span id="breadcrumbs-current">help</span> </span>
...
[OpenSolaris Virtualbox Guest and NFS](https://blog.swatteksystems.com/old/archive/2009/09/24/opensolaris-virtualbox-guest-and-nfs) {#opensolaris-virtualbox-guest-and-nfs .weblog-view-entry-title}
--------------------------------------------------------------------------------------------------------------------------------
...
[](https://blog.swatteksystems.com/old/topics/howto)
[](https://blog.swatteksystems.com/old/topics/virtualhost)
[](https://blog.swatteksystems.com/old/topics/OpenSolaris)
[](https://blog.swatteksystems.com/old/topics/unix)
[](https://blog.swatteksystems.com/old/topics/NFS)
[](https://blog.swatteksystems.com/old/topics/linux)
[](https://blog.swatteksystems.com/old/topics/host)
[](https://blog.swatteksystems.com/old/topics/guide)
[](https://blog.swatteksystems.com/old/topics/virtualbox)
[](https://blog.swatteksystems.com/old/topics/guest)
...
— last modified Sep 24, 2009 12:47 PM
...
-   [howto](https://blog.swatteksystems.com/old/topics/howto)
-   [virtualhost](https://blog.swatteksystems.com/old/topics/virtualhost)
-   [OpenSolaris](https://blog.swatteksystems.com/old/topics/OpenSolaris)
-   [unix](https://blog.swatteksystems.com/old/topics/unix)
-   [NFS](https://blog.swatteksystems.com/old/topics/NFS)
-   [linux](https://blog.swatteksystems.com/old/topics/linux)
-   [host](https://blog.swatteksystems.com/old/topics/host)
-   [guide](https://blog.swatteksystems.com/old/topics/guide)
-   [virtualbox](https://blog.swatteksystems.com/old/topics/virtualbox)
-   [guest](https://blog.swatteksystems.com/old/topics/guest)
...
I came up against an issue mounting via nfs from a Linux host to an
OpenSolaris virtualbox guest (see [this
post](https://blog.swatteksystems.com/old/topics/help/archive/2009/07/24/automount-nfs){.external-link}
for automounting nfs on OpenSolaris). Checking the host's logs revealed
the issue: <span class="searchword2">mountd:  \[...\] refused mount
request \[..\] illegal port.</span>

This is seemingly caused due to the natted connection between guest and
host. Adding (insecure) in the host's /etc/exports line for this export
enabled the guest to successfully mount the nfs share.\
<span class="searchword2"></span><span class="searchword3"></span>
...
[OpenSolaris b122 and ATI sb600/700 ahci](https://blog.swatteksystems.com/old/archive/2009/09/11/opensolaris-b122-and-ati-sb600-700-ahci) {#opensolaris-b122-and-ati-sb600700-ahci .weblog-view-entry-title}
--------------------------------------------------------------------------------------------------------------------------------------

<div class="weblog-topic-images">

[](https://blog.swatteksystems.com/old/topics/opensolaris)
[](https://blog.swatteksystems.com/old/topics/laptop)
[](https://blog.swatteksystems.com/old/topics/help)
[](https://blog.swatteksystems.com/old/topics/HP)
[](https://blog.swatteksystems.com/old/topics/ahci)
[](https://blog.swatteksystems.com/old/topics/howto)
[](https://blog.swatteksystems.com/old/topics/OpenSolaris)
[](https://blog.swatteksystems.com/old/topics/sata)
[](https://blog.swatteksystems.com/old/topics/help/https://blog.swatteksystems.com/old/topics/dv7%201245ca)
[](https://blog.swatteksystems.com/old/topics/bug)
...
<span> by </span>
[https://swattek.pip.verisignlabs.com/](https://blog.swatteksystems.com/old/authors/https://swattek.pip.verisignlabs.com/)
— last modified Sep 11, 2009 03:25 PM
...
-   [opensolaris](https://blog.swatteksystems.com/old/topics/opensolaris)
-   [laptop](https://blog.swatteksystems.com/old/topics/laptop)
-   [help](https://blog.swatteksystems.com/old/topics/help)
-   [HP](https://blog.swatteksystems.com/old/topics/HP)
-   [ahci](https://blog.swatteksystems.com/old/topics/ahci)
-   [howto](https://blog.swatteksystems.com/old/topics/howto)
-   [OpenSolaris](https://blog.swatteksystems.com/old/topics/OpenSolaris)
-   [sata](https://blog.swatteksystems.com/old/topics/sata)
-   [dv7
    1245ca](https://blog.swatteksystems.com/old/topics/help/https://blog.swatteksystems.com/old/topics/dv7%201245ca)
-   [bug](https://blog.swatteksystems.com/old/topics/bug)

</div>

Updating OpenSolaris b121 to b122 results in kernel panic (NOTICE:
spa\_import\_rootpool: error 5)

<div class="plain">

Upgrading to the b122 bits on my laptop resulted in a kernel panic and
reboots upon boot attempt. See this
bug:<https://bugs.opensolaris.org/bugdatabase/view_bug.do?bug_id=6875025>

My work-around for this is to boot into my working BE (b121) and do the
following:
